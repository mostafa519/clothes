...
const ProductsByShop = () => {
  ...
  useEffect(() => {
    Instance.get(
      `https://labsny.net/api/clothes?search=${state.shop_id}&searchFields=shop_id`
    )
          ...
          <Row>
            {products.length >= 1 &&
              products.map((product) => (
                ...
                <Col className="col-12 col-sm-6 col-lg-3 mb-3" key={product.id}>
